...
it('evaluates class::const fetch', function () {
    ...
    $ctx->shouldReceive('resolve')->with(ReflectionMethod::class)->andReturn(ReflectionMethod::class);
...
it('evaluates self::const fetch', function () {
    $ctx = mock(Context::class);
    $ctx->shouldReceive('resolve')->with('self')->andReturn(ReflectionMethod::class);
...
it('evaluates static::const fetch', function () {
    $ctx = mock(Context::class);
    $ctx->shouldReceive('resolve')->with('static')->andReturn(ReflectionMethod::class);
...
it('evaluates parent::const fetch', function () {
    $ctx = mock(Context::class);
    $ctx->shouldReceive('resolve')->with('parent')->andReturn(ReflectionMethod::class);
...
it('evaluates MissingClass::const fetch', function () {
    $ctx = mock(Context::class);
    $ctx->shouldReceive('resolve')->andReturn('MissingClass');
